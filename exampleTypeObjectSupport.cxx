...
/*!
 * @file exampleTypeObjectSupport.cxx
 * Source file containing the implementation to register the TypeObject representation of the described types in the IDL file
 *
 * This file was generated by the tool fastddsgen.
 */

#include "exampleTypeObjectSupport.hpp"
...
void register_example_type_identifier(
        TypeIdentifierPair& type_ids_example)
{

    ReturnCode_t return_code_example {eprosima::fastdds::dds::RETCODE_OK};
    return_code_example =
        eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
        "example", type_ids_example);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_example)
    {
        StructTypeFlag struct_flags_example = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        QualifiedTypeName type_name_example = "example";
        eprosima::fastcdr::optional<AppliedBuiltinTypeAnnotations> type_ann_builtin_example;
        eprosima::fastcdr::optional<AppliedAnnotationSeq> ann_custom_example;
        CompleteTypeDetail detail_example = TypeObjectUtils::build_complete_type_detail(type_ann_builtin_example, ann_custom_example, type_name_example.to_string());
        CompleteStructHeader header_example;
        header_example = TypeObjectUtils::build_complete_struct_header(TypeIdentifier(), detail_example);
        CompleteStructMemberSeq member_seq_example;
        {
            ...
            ann_custom_example.reset();
            CompleteMemberDetail detail_index = TypeObjectUtils::build_complete_member_detail(name_index, member_ann_builtin_index, ann_custom_example);
            CompleteStructMember member_index = TypeObjectUtils::build_complete_struct_member(common_index, detail_index);
            TypeObjectUtils::add_complete_struct_member(member_seq_example, member_index);
        }
        {
            ...
            ann_custom_example.reset();
            CompleteMemberDetail detail_message = TypeObjectUtils::build_complete_member_detail(name_message, member_ann_builtin_message, ann_custom_example);
            CompleteStructMember member_message = TypeObjectUtils::build_complete_struct_member(common_message, detail_message);
            TypeObjectUtils::add_complete_struct_member(member_seq_example, member_message);
        }
        CompleteStructType struct_type_example = TypeObjectUtils::build_complete_struct_type(struct_flags_example, header_example, member_seq_example);
        if (eprosima::fastdds::dds::RETCODE_BAD_PARAMETER ==
                TypeObjectUtils::build_and_register_struct_type_object(struct_type_example, type_name_example.to_string(), type_ids_example))
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "example already registered in TypeObjectRegistry for a different type.");
        }
    }
}
